...
// Game Graphics Setup ------------------------------------------
	...
	array<string, 15> ar = {"Trash can.png", "Trash can fallen.png", "Traffic cone.png", "Street baracade.png", "Street baracade 2.png",
...
// Main Game Loop -----------------------------------------------
	while (window.isOpen())
	{
        ...
        {	
	        ...
	        obstacleTexture.loadFromFile(ar[oNumber]);
